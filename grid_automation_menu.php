...
<head>
    ...
    <link rel="stylesheet" href="styles/grid_automation_menu_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="grid_automation.php">Grid Automation &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
            ...
            <!-- <div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Medium voltage Switcher</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Medium voltage Transformer</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Feeder Automation</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Substation Automation</span><i class="fas fa-angle-right"></i></a></li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Grid Automation Product</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product4/grid_product1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                       <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product5.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product6.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product7.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product8.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product4/grid_product9.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Grid Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
