    ...
    <div id="carouselExampleCaptions" class="carousel carousel-fade slide" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="caption">
            <h1 class="h1 my-5">"STAY POWERFUL !!!"</h1>
            <div class="para">
              <p class="p my-5">Vewon is an electric and energy service company. We offer technology based solutions to clients.</p>
            </div>
        ...
        <div class="carousel-item">
          ...
          <div class="caption">
            <h1 class="h1 my-5">"STAY CONNECTED !!!"</h1>
            <div class="para">
              <p class="p my-5">Vewon build community that serves as society and act as family</p>
            </div>
            <a class="btn btn-primary learn-more-btn invisible" href="#" role="button">Learn more</a>
          </div>
        </div>
