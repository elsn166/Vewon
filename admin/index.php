...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider my-0 mb-3">
              ...
              <li class="nav-item active" id="active">
                <a class="nav-link" href="./index2.php" style="font-family: 'Poppins', sans-serif;">
    ...
    <script>
        ...
        data: {
            ...
            $calcRiskFreeresult2 = mysqli_num_rows($calcRiskFree2);
            echo $calcRiskFreeresult2;?>],
            backgroundColor: [ '#ffdf00', '#20c997', '#dc3545'], //1st color before 5 years, 2nd after 5 years, 3rd over 10 years
            hoverBackgroundColor: [ '#ffcd39', '#1aa179', '#b02a37'],
