...
VALUES ('$Temail', '$txtCountry', '$txtSitename', '$txtAddress', '$txtCity', '$txtType', '$txtBuilding', '$txtFloor', '$txtroom', '$txtLineup', '$txtNameofasset', '$txtAssetNo', '$txtQuantityNo', 'no', 'no', 'no', '$txtRiskcapacity', 'no', '$txtinstalleddate', '$diff_old', '$txtexpired', '$Temparature', '$Pressure', '$Rpm')";
