...
$sql = "INSERT INTO service_register_asset (work_order, date1, service_visit, contract1, primary_name, pdf, status)
VALUES ('$txtWorkorder', '$txtDate', '$txtServicevisit', '$txtContract', '$txtPrimaryname', '$re', 'pending')";
