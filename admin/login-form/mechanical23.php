<form action="register_asset1.php" method="POST" class="login100-form validate-form">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="wrap-input100">
                                                        <select class="input100 select" id="type" name="type" required>
                                                            ...
                                                            <option value="mechanical" selected id="mech">Mechanical</option>
                                                        </select>
                                                    ...
                                                    <!-- FOR Voltage Level -->
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="temp" id="voltage_level" placeholder="Temparature" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
                                                    ...
                                                    <!-- FOR Current Rating -->
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="pressure" id="current_rating" placeholder="Pressure" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
                                                    ...
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="rpm" id="frequency" placeholder="RPM" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
