                        ...
                        <div class="container-login100">
                            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                                ...
                                <div class="wrap-input100 rs1">
                                        <select class="input100" name="custlist" id="custlist" required>
                                            
                                            <option value="Electrical" selected>Electrical (Type of Asset)</option>
                                            <option value="Mechanical">Mechanical (Type of Asset)</option>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="wrap-input100">
                                                        <select class="input100 select" id="type" name="type" required>
                                                            ...
                                                            <option value="electrical" selected id="elec">Electrical</option>
                                                    ...
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="frequency" id="frequency" placeholder="Frequency/Cycle" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
...
$('#custlist').change(function(event){
	

var ty=document.getElementById('custlist').value;
