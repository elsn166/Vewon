        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Custom Components:</h6> -->
                        <a class="collapse-item active-item" href="./upcoming.php" style="font-family: 'Poppins', sans-serif;font-weight: 500;"><i class="material-icons-outlined" style="margin-left: -5px;">upcoming</i>&nbsp;&nbsp;Upcoming</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Nunito', sans-serif;font-weight: bold;">Upcoming</h1>
                        <a href="login-form/service_visit_form.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="font-family: 'Poppins', sans-serif; font-weight: bold;"><i class="fas fa-scroll fa-sm text-white-50"></i>&nbsp; Add Service Visits</a>
                    </div>
                            ...
                            <div class="row">
                                <!-- <div class="col-lg-3 col-md-6"> -->
                                    ...
                                    <!-- <div class="card shadow-sm mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="register_asset.php" method="POST" enctype="multipart/form-data" class="form-group">
                                                <div class="form-group">
                                                    <label class="form-label" for="starting-date">Starting Date</label>
                                                    <input class="form-input" type="date" id="post_at" name="search[post_at]" value="<?php echo $post_at; ?>" id="starting-date" style="width: 100%;">
                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="ending-date">Ending-date</label>
                                                    <input class="form-input" type="date" id="post_at_to_date" name="search[post_at_to_date]" value="<?php echo $post_at_to_date; ?>" id="ending-date" style="width: 100%;">
                                                </div>

                                                <button class="btn btn-block btn-outline-primary" type="submit" name="go" value="Search">Search</button>
                                            </form> 
                                        </div>
                                    </div> -->
                                <!-- </div>  -->
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered display" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT work_order,date1,service_visit,contract1,primary_name,pdf,status FROM service_register_asset WHERE date1 > DATE(NOW())";
                                                        ...
                                                        echo '<tr>
                                                            ...
                                                            <td>' . $row["date1"] .'</td>
                                                            <td>' . $row["service_visit"] .'</td>
                                                            <td>' . $row["contract1"] .'</td>
                                                            <td>' . $row["primary_name"] .'</td>
                                                            <td>' . $row["pdf"] .'</td>
                                                            <td>' . $row["status"] .'</td>
                                                            <td><button id="btn1" class="btn1"><i class="fas fa-pen text-center edit"></i></button></td>
                                                ...
                                                ?>
                                                        <!--<tr>-->
                                                        <!--    <td>WO-38374</td>-->
                                                        <!--    <td class="text-center">20/04/2008</td>-->
                                                        <!--    <td class="text-center">IT Support</td>-->
                                                        <!--    <td class="text-center">UENV-008J3</td>-->
                                                        <!--    <td class="text-center">Kevin Paul</td>-->
                                                        <!--    <td class="text-warning text-center"><i class="fas fa-sync-alt"></i> Renewal requested</td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <td>WO-73928</td>-->
                                                        <!--    <td class="text-center">25/12/2003</td>-->
                                                        <!--    <td class="text-center">Commission</td>-->
                                                        <!--    <td class="text-center">DUWJ-372JF9</td>-->
                                                        <!--    <td class="text-center">John Mike</td>-->
                                                        <!--    <td class="text-success text-center"><i class="fas fa-check-circle"></i>&nbsp; Current</td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <td>WO-39278</td>-->
                                                        <!--    <td class="text-center">25/12/2003</td>-->
                                                        ...
                                                        <!--    <td class="text-center">DUWJ-372JF9</td>-->
                                                        <!--    <td class="text-center">John Mike</td>-->
                                                        <!--    <td class="text-danger text-center"><i class="fas fa-exclamation-triangle"></i> Expiring</td>-->
                                                        <!--</tr>-->
    ...
    $(document).ready(function() {
            ...
            
            {
                ...
                $.ajax({
                    url: 'tre.php',
                    type: 'GET',
                    data: { var_PHP_data: tus,dta1:tus1,dta2:tus2,dta3:tus3,dta4:tus4 },
                    success: function(data) {
                        $('#dataTable').html(data);
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
