            ...
            <li class="nav-item active" id="active">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active-item" href="javascript:void(0);" style="font-family: 'Poppins', sans-serif;"><i class="material-icons-outlined" style="margin-left: -5px;">account_box</i>&nbsp;&nbsp;Manage</a>
...
<!-- Nav Item - Alerts -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Nunito', sans-serif;font-weight: bold;">Manage</h1>
                    ...
                    <!--************** Card Section 1 Starts Here **************-->
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card shadow mb-3">
                                <div class="card-body">
                                    <div class="card-section1" style="display: block;padding: 8px 10px;">
                                        <div class="card-heading" style="margin-bottom: 20px;">
                                            <h4>Digital Asset Performance Management Services</h4>
                                        </div>

                                        <div class="card-description">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia non temporibus minus, distinctio tempore laborum dolor nihil quo ipsam dicta tempora laboriosam rerum! Deserunt illum officiis consectetur harum labore commodi?</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card shadow-sm">
                                                <img class="card-img-top" src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card shadow-sm">
                                                <img class="card-img-top" src="https://images.unsplash.com/photo-1580983553600-c49a1d083f54?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                                <div class="card-body">
                                                  <h5 class="card-title">Card title</h5>
                                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                                  <ul>
