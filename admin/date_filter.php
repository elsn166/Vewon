            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Nunito', sans-serif;font-weight: bold;">Current</h1>
                                        ...
                                        <div class="card-body">
                                            <form action="" method="GET" class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-input" type="date" name="starting_date" id="starting_date" value="<?php if(isset($_GET['starting_date'])){ echo $_GET['starting_date']; } ?>" style="width: 100%;">
                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="ending-date">Ending Date</label>
                                                    <input class="form-input" type="date" name="ending_date" id="ending_date" value="<?php if(isset($_GET['ending_date'])){ echo $_GET['ending_date']; } ?>" style="width: 100%;">
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered display" id="dataTable1" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if(isset($_GET['starting_date']) && ($_GET['ending_date'])){
                                                            $from_date = $_GET['starting_date'];
                                                            $end_date = $_GET['ending_date'];
                                                            
                                                            $query = "SELECT * FROM register_asset WHERE date1 BETWEEN '$from_date' AND '$end_date'";
                                                        ...
                                                        ?>
                                                         ...
                                                         <!-- <tr>
                                                            <td>IT-37463</td>
                                                            <td>ABC Company-Boston-SITE</td>
                                                            <td class="text-center">10</td>
                                                            <td class="text-center">2/08/2004</td>
                                                            <td class="text-center">24/02/2006</td>
                                                            <td class="text-danger text-center"><i class="fas fa-exclamation-triangle"></i>Expiring</td>
                                                        </tr>
                                                        <tr>
                                                            <td>IT-38374</td>
                                                            <td>ABC Company-Creteil South Paris-SITE</td>
                                                            <td class="text-center">17</td>
                                                            <td class="text-center">22/04/2007</td>
                                                            <td class="text-center">23/07/2008</td>
                                                            <td class="text-warning text-center"><i class="fas fa-sync-alt"></i>Renewal requested</td>
                                                        </tr>
                                                        <tr>
                                                            <td>IT-34387</td>
                                                            <td>ABC Company-La Defence Paris-SITE</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">4/05/2003</td>
                                                            <td class="text-center">30/08/2005</td>
                                                            <td class="text-danger text-center"><i class="fas fa-exclamation-triangle"></i>Expiring</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td>72HD-83PNW-HD83J</td>
                                                            <td>ABC Company-La Defence Paris-SITE</td>
                                                            <td class="text-center">2</td>
                                                            <td class="text-center">3/08/2006</td>
                                                            <td class="text-center">8/02/2008</td>           
                                                            <td class="text-danger text-center"><i class="fas fa-exclamation-triangle"></i>Expiring</td>
                                                        </tr>
                                                        <tr>
                                                            <td>JWU-8778-UWC803K</td>
                                                            <td>ABC Company-Creteil South Paris-SITE</td>
                                                            <td class="text-center">4</td>
                                                            <td class="text-center">22/08/2008</td>
                                                            <td class="text-center">22/08/2008</td>
                                                            <td class="text-warning text-center"><i class="fas fa-sync-alt"></i>Renewal requested</td>
                                                        </tr>
                                                        <tr>
                                                            <td>HIWU-8573J-IOWD8</td>
                                                            <td>ABC Company-Les Corts Barcelona-SITE</td>
