            ...
            <li class="nav-item active" id="active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active-item" href="./ongoing.php" style="font-family: 'Poppins', sans-serif;"><i class="material-icons-outlined" style="margin-left: -5px;">arrow_forward</i>&nbsp; Ongoing</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Nunito', sans-serif;font-weight: bold;">Ongoing</h1>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered display" id="dataTable5" width="100%" cellspacing="0">
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="5">No Ongoing Events</td>
                                                    </tr>
                                                    <?php
                                                    // echo "0 results";
                                                } 
...
$('#logout').click(function(event){
    ...
    $(document).ready(function() {
            // $('#sub').click(function() 
            $('#dataTable5').on('click', '#btn1', function()
