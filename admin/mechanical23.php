                                        ...
                                        <div class="card">
                                            ...
                                            <div id="section1ContentId" class="collapse in" role="tabpanel" aria-labelledby="section1HeaderId">
                                                <div class="card-body">
                                                    ...
                                                    <!-- FOR Voltage Level -->
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="voltage_level" id="voltage_level" placeholder="Temparature" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
                                                    ...
                                                    <!-- FOR Current Rating -->
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="current_rating" id="current_rating" placeholder="Pressure" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
                                                    ...
                                                    <div class="wrap-input100 rs1">
                                                        <input class="input100" type="text" name="frequency" id="frequency" placeholder="RPM" required>
                                                        <span class="focus-input100-1"></span>
                                                        <span class="focus-input100-2"></span>
                                                    </div>
