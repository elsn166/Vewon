    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="active">
                <a class="nav-link" href="./index4.php" style="font-family: 'Poppins', sans-serif;">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Before 5 Years
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> After 5 Years
                                        </span>
                                        <span class="mr-2">
