...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Design Engineering and Energy Systems | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/design_engg.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://mixers.mixmor.com/Asset/manufacturing-plan-e1392849473260.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Design Engineering and Energy Systems</h1>
            <!-- <div class="para">
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://media.istockphoto.com/photos/two-architect-working-at-construction-site-and-compass-drawing-on-picture-id1224506889?b=1&k=20&m=1224506889&s=170667a&w=0&h=Nu5fZy_i3r0k1BbXaVFrFnH7hs8piZXWrUe7zVPx21E=" alt="Architect Image">
                                    </div>
                                </div>
