...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Access to Energy | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/access_to_energy.css" />
      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-touch="true" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1576256932046-62148e2efdce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=751&q=80" class="d-block w-100" alt="Image">
            <div class="banner-text">
              <h3>Access to Energy Products</h3>
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card inside-card">
                  <div class="card-body">
                    <div class="card-sec1">
                      <h3>Enabling sustainable access to energy</h3>
        ...
        <!-- BIG CARD SECTION -->
              ...
              <div class="title-card-section2">
                <div class="title-section2">
                  <h3>Discover our product ranges</h3>
                </div>
              </div>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-4">
                        <div class="card shadow-sm mb-2">
                          <img src="https://images.unsplash.com/photo-1587582423116-ec07293f0395?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                          <div class="card-body">
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="card shadow-sm mb-2">
                          <img src="https://images.unsplash.com/photo-1565954786194-d22abeaac3ae?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="card shadow-sm mb-2">
                          <img src="https://images.unsplash.com/photo-1589792923962-537704632910?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                          <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                  ...
                  <div class="splide__track">
                    <ul class="splide__list">
                      <li class="splide__slide">
                        <a href="small_business_products.php" class="text-decoration-none">
                          <div class="card card-size">
                            <img src="https://m.media-amazon.com/images/I/31nqHYaaCKL._AC_SS450_.jpg" class="card-img-top" alt="Card Image">
                            <div class="card-body">
                      ...
                      <li class="splide__slide">
                        <a href="small_business_products.php" class="text-decoration-none">
                          <div class="card card-size">
                            <img src="https://5.imimg.com/data5/SELLER/Default/2021/3/QO/HE/ZI/107164466/fire-control-panel-500x500.jpg" class="card-img-top" alt="Card Image">
                            <div class="card-body">
                              <p class="card-text text-dark">Product Name</p>
                            </div>
                          </div>
                      ...
                      <li class="splide__slide">
                        <a href="small_business_products.php" class="text-decoration-none">
                          <div class="card card-size">
                            <img src="https://5.imimg.com/data5/DK/FU/MY-2346938/annunciation-panel-500x500.jpg" class="card-img-top" alt="Card Image">
                            <div class="card-body">
                              <p class="card-text text-dark">Product Name</p>
                            </div>
                          </div>
                      ...
                      <li class="splide__slide">
                        <a href="small_business_products.php" class="text-decoration-none">
                          <div class="card card-size">
                            <img src="https://2.imimg.com/data2/QO/GB/MY-4638649/anociator-panel-250x250.jpg" class="card-img-top" alt="Card Image">
                            <div class="card-body">
                              <p class="card-text text-dark">Product Name</p>
                            </div>
                          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1589939705384-5185137a7f0f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
            ...
            <div class="col-md-6">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1584276433295-4b49a252e5ee?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=742&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
