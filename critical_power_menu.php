...
<head>
    ...
    <link rel="stylesheet" href="styles/critical_power_menu_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="critical_power.php">Critical & Industrial Power &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
            ...
            <!-- <div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Cooling</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Critical Power and Cooling Services</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Data Center Software</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>IT Power Distribution</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Racks and Accessories</span><i class="fas fa-angle-right"></i></a></li>
                  </ul>
                </div>
              </div>
            </div> -->
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Data Center Product</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product3/product1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/product3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center5.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center6.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center7.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center8.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                       <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product5/data_center9.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Data Center Product" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
