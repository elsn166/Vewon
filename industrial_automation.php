...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Industrial Automation | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/industrial_automation.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://assets.usesi.com/contentmanager/content/Industrial_automation_1.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Industrial Automation</h1>
            <!-- <div class="para">
            ...
            <a class="btn btn-primary learn-more-btn" role="button">Learn More</a> -->
          </div>
        </div>

        <!-- <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1555421689-491a97ff2040?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="d-block w-100" alt="image">
          <div class="caption">
            <h1 class="h1">Industrial Automation Business</h1>
            <div class="para">
              <p class="p">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt temporibus recusandae debitis voluptate labore aut. Praesentium et officiis reprehenderit ullam nihil, quisquam ipsum ducimus impedit, aliquam obcaecati suscipit asperiores animi?</p>
            </div>
        ...
        <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1504270997636-07ddfbd48945?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=751&q=80" class="d-block w-100" alt="Image">
          <div class="caption">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card inside-card">
                  <div class="card-body">
                    <div class="card-sec1">
                      <h3>Building Automation & Control Systems</h3>
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://thumbs.dreamstime.com/b/industrial-automation-automatic-lines-robotic-78236935.jpg" alt="Industrial Automation Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>The main focus of this Vewon Groups business is to provide customers with products and solutions for instrumentation, automation and optimization of industrial processes.  </p>
                                        <p>The industries served include Programmable Logic Controllers PLC, Distributed Control System DCS, field industrial devices, and more.  </p>
                                        <p>Key customer benefits include improved asset productivity and energy savings.  </p>
      ...
      <!-- CARD SECTION 2-->
        <!-- <div class="title-card-section2">
          <div class="title-section2">
            <h3>Featured Industrial Automation products</h3>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1573495627361-d9b87960b12d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1573496528736-cf543ba57104?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1573496799822-b0557c9e2f41?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1573166855576-5e6dca380e7d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1581093805920-c5666c544c08?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1581091224003-01e7c2e69f6f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1622675205169-901710ac8643?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1581091870598-36ce9bad5c77?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1581089781785-603411fa81e5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
            ...
            <div class="col-md-6">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1581092567449-1bd7ebaffeb4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
