...
<head>
    ...
    <link rel="stylesheet" href="styles/industrial_automation_menu_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="industrial_automation.php">Industrial Automation &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
              ...
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    ...
                    <li><a href="product_menu_items.php"><span>Industrial Communication</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Enclosures and Accessories</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Industrial Automation Software</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Process Control and Safety</span><i class="fas fa-angle-right"></i></a></li>
                  </ul>
                </div>
              </div>
            </div> -->
                    ...
                    <ul class="row no-gutters">
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">PLC Controller</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/industrial_automation_products/plc1.jpeg" class="img-fluid rounded-start" class="card-img-bottom" alt="PLC Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/plc2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="PLC Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/plc3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="PLC Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Motor Starter</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/industrial_automation_products/motor_starter1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Motor Starter" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/motor_starter2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Motor Starter" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/motor_starter3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Motor Starter" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Contactor</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/industrial_automation_products/contactor1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Contactor" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/contactor2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Contactor" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/industrial_automation_products/contactor3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Contactor" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
