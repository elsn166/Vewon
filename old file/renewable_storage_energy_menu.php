...
<head>
    ...
    <link rel="stylesheet" href="styles/renewal_storage_energy_menu_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="renewal_storage_energy.php">Renewable and Storage Energy &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
             ...
             <!-- <div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Grid-Tie String Inventers</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Residental Energy Storage</span><i class="fas fa-angle-right"></i></a></li>

                   <li><a href="product_menu_items.php"><span>Emergency Lighting</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Power Monitoring and Control</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Contractors and Protection Relays</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Network Connectivity</span><i class="fas fa-angle-right"></i></a></li>
                  </ul>
                </div>
              </div>
            </div> -->
                    ...
                    <ul class="row no-gutters">
                      <li class="col-md-6 col-lg-4">
                       <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Hybrid Inventer</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product3/product1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Hybrid Inventer" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/product2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Hybrid Inventer" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/product3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Hybrid Inventer" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/hybrid_inverter4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Hybrid Inventer" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/hybrid_inverter5.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Hybrid Inventer" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Solar Charge Controller</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product3/product1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/product2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/product3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product3/solar_charge_controller4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
                  ...
                  <li>
                    <a href="product_menu_items.php" class="text-decoration-none text-dark">
                      <div class="card text-center">
                        ...
                        <img src="img/product3/solar_charge_controller1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="product_menu_items.php" class="text-decoration-none text-dark">
                      <div class="card text-center">
                        ...
                        <img src="img/product3/solar_charge_controller2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="product_menu_items.php" class="text-decoration-none text-dark">
                      <div class="card text-center">
                        ...
                        <img src="img/product3/solar_charge_controller3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Solar Charge Controller" id="resize">
                      </div>
                    </a>
                  </li>
