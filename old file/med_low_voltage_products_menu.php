...
<head>
    ...
    <link rel="stylesheet" href="styles/med_low_voltage_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="med_low_voltage_products.php">Medium & Low Voltage Products &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
            ...
            <!-- <div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Access Control</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Fire Detection</span><i class="fas fa-angle-right"></i></a></li>
                    ...
                    <li><a href="product_menu_items.php"><span>Sensors & Room Units</span><i class="fas fa-angle-right"></i></a></li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">MV and LV Product</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product1/lv-and-mv1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv5.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv6.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv7.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv8.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product1/lv-and-mv9.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="MV and LV Product" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
