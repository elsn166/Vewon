...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Renewable and Storage Energy | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/renewal_storage_energy.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <!-- <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1574360773950-133867861ae9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Solar Business</h1>
            <div class="para">
            ...
            <a class="btn btn-primary learn-more-btn js-modal-btn" data-video-id="iYV4c-zwotU" role="button">Learn More</a>
          </div>
        </div>

        <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1594818379496-da1e345b0ded?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=890&q=80" class="d-block w-100" alt="image">
          <div class="caption">
            <h1 class="h1">Solar Business</h1>
            <div class="para">
              <p class="p">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt temporibus recusandae debitis voluptate labore aut. Praesentium et officiis reprehenderit ullam nihil, quisquam ipsum ducimus impedit, aliquam obcaecati suscipit asperiores animi?</p>
            </div>
            <a class="btn btn-primary learn-more-btn js-modal-btn" data-video-id="uIgO1bf1UMs" role="button">Learn More</a>
          </div>
        </div> -->

        <div class="carousel-item active">
          <img src="https://images.unsplash.com/photo-1498084393753-b411b2d26b34?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=889&q=80" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Renewable & Energy Storage</h1>
            <!-- <div class="para">
              <p class="p">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt temporibus recusandae debitis voluptate labore aut. Praesentium et officiis reprehenderit ullam nihil, quisquam ipsum ducimus impedit, aliquam obcaecati suscipit asperiores animi?</p>
            </div>
            <a class="btn btn-primary learn-more-btn js-modal-btn" data-video-id="e60Tsu7xPDc" role="button">Learn More</a> -->
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card inside-card">
                  <div class="card-body">
                    <div class="card-sec1">
                      <h3>The Power of True Bankability</h3>
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://www.greenmatch.co.uk/media/2467663/types-of-solar-panels.jpg?anchor=center&mode=crop&width=1200&height=630" alt="Solar Service Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>Vewon Groups is a team of Engineering specialists and proven expertise by rendering excellent services with safety tests to clients. </p>
                                        <p>We gratify to provide modern design, erection, examination, and commissioning of electrical HT\LT machine, controller relay board, digital relays, and substation computerization.  </p>
                                        <p>We deliver services and products for all the classified criteria in energy storage techniques.   </p>
                            ...
                            <div class="card-body">
                                <ul class="d-flex">
                                    <li class="row no-gutters list-row">
                                        <div class="col-md-6 image-card-section">
                                            <div class="card-image">
                                                <img src="https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <ul class="d-flex">
                                    <li class="row no-gutters list-row">
                                        <div class="col-md-6 image-card-section">
                                            <div class="card-image">
                                                <img src="https://images.unsplash.com/photo-1581094488379-6a10d04c0f04?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <ul class="d-flex">
                                    <li class="row no-gutters list-row">
                                        <div class="col-md-6 image-card-section">
                                            <div class="card-image">
                                                <img src="https://images.unsplash.com/photo-1581092162384-8987c1d64718?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                            </div>
                                        </div>
      ...
      <!-- CARD SECTION 2-->
        <!-- <div class="title-card-section2">
          <div class="title-section2">
            <h3>Discover our Solar & Energy Storage</h3>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1580983230429-21b05ca12c18?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1580982324076-d95230549339?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1581092333203-42374bcf7d89?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1573496546639-d1c0722d1674?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
