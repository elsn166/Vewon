...
$sql = "INSERT INTO register_asset (email, country, site_name, address1, city, type1, building, floor_no, room, line_up, name_of_asset, asset_no,quantity, voltage_level, current_rating, short_circuit, risk_capacity, frequency, installed_date, diff_old, end_date)
VALUES ('$Temail', '$txtCountry', '$txtSitename', '$txtAddress', '$txtCity', '$txtType', '$txtBuilding', '$txtFloor', '$txtroom', '$txtLineup', '$txtNameofasset', '$txtAssetNo', '$txtQuantityNo', '$txtVoltagelevel', '$txtCurrentrating', '$txtShortcircuit', '$txtRiskcapacity', '$txtFrequency', '$txtinstalleddate', '$diff_old', '$txtexpired')";
