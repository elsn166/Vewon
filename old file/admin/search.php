                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="row">
                                ...
                                <!--        <div class="card-body">-->
                                <!--            <form action="date_filter.php" method="GET" class="form-group">-->
                                <!--                <div class="form-group">-->
                                <!--                    <label class="form-label" for="starting-date">Starting Date</label>-->
                                <!--                    <input class="form-input" type="date" name="starting_date" id="starting_date" style="width: 100%;">-->
                                <!--                </div>-->

                                <!--                <div class="form-group">-->
                                <!--                    <label class="form-label" for="ending-date">Ending Date</label>-->
                                <!--                    <input class="form-input" type="date" name="ending_date" id="ending_date" style="width: 100%;">-->
                                <!--                </div>-->
                                                ...
                                                <table class="table table-bordered display" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        if(isset($_GET['search'])){
                                                            ...
                                                            $query = "SELECT * FROM register_asset WHERE CONCAT(name_of_asset, site_name, quantity, installed_date, end_date) LIKE '%$filtervalues%'";
                                                            ...
                                                            if(mysqli_num_rows($query_run) > 0){
                                                                foreach($query_run as $items){
                                                                    ...
                                                                    <tr>
                                                                        <td><?= $items["name_of_asset"] ?></td>
                                                                        <td><?= $items["site_name"] ?></td>
                                                                        <td><?= $items["quantity"] ?></td>
                                                                        <td><?= $items["installed_date"] ?></td>
