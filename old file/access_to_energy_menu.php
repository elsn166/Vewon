        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="access_to_energy.php">Access to Energy &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
             ...
             <!--<div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Collective Solutions</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Home Systems</span><i class="fas fa-angle-right"></i></a></li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="#" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="https://img.freepik.com/free-photo/black-headphones-white-background_301038-530.jpg?size=626&ext=jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Product Image">
                          </div>
                        </a>
                      </li>
