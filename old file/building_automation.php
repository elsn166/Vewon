...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Building Automation | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/building_automation.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/building_automation1.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Building Automation</h1>
            <!-- <div class="para">
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://media.istockphoto.com/photos/portrait-man-worker-under-inspection-and-checking-production-process-picture-id1248388606?k=20&m=1248388606&s=612x612&w=0&h=yfVOl-E-v_dVExJ0XKnJWGP-zxeQ3HJJAHWMjt-5r9U=" alt="Architect Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>Vewon Groups supports powerful and intelligent facilities with associated solutions for a healthy environment. This unique organization of industry-leading technology solutions makes your business goals strengthening on all three pillars for supreme influence. </p>
                                        <p>Habitual visits by our professional experts are carried out at patrons' sites on respectively agreed dates. We suggest necessary parts and consumables be stocked concerning minimum downtime of machinery. </p>
