...
<head>
    ...
    <title>Product Items | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/product_menu_items_style.css" />
      ...
      <div class="container-fluid wrapper">
        <div class="describe-wrapper">
          ...
          <div class="product-content-description">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione neque recusandae aut quam! Modi natus perferendis eum nobis aspernatur ullam, ad magni neque tempore, obcaecati recusandae placeat eligendi. Nihil, inventore?Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea facilis quos dignissimos? Aliquam, qui ut adipisci consequatur consequuntur doloribus, voluptatem tempora magnam vitae sapiente laudantium. Quibusdam minima quos dicta neque.</p>
          </div>
        </div>
      <!-- PRODUCT OUTLINE DETAILS END-->
          ...
          <div class="product-grid">
            <!--<div class="product-grid-column-1">
              <div class="product-title-header">
                <h5>Filter by</h5>
                <a role="button" class="reset-btn"><i class="fas fa-sync"></i>&nbsp; Reset all</a>
              </div>
                        ...
                        <ul>
                          <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox1"> Product Type Name</label>
                            </div>
                          </li>
        
                          <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox2"> Product Type Name</label>
                            </div>
                          </li>
        
                          <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox3"> Product Type Name</label>
                            </div>
                          </li>
        
                           <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox4"> Product Type Name</label>
                            </div>
                          </li>
        
                          <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox5"> Product Type Name</label>
                            </div>
                          </li>
        
                          <li>
                            <div class="form-check">
                              <label><input class="uk-checkbox check uncheck" type="checkbox" value="Product Type Name" name="checkbox" id="checkbox6"> Product Type Name</label>
                            </div>
                          </li> 
                        </ul>
                      </div>
              ...
              <div class="product-content-section">
                <section class="first-section">
                  <div class="first-section-title">
                    <h2><a href="#" class="
                      text-decoration-none text-dark">Panel and Protection</h2></a>
                    <div class="first-section-title-description">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed nihil molestias minima hic maxime laboriosam commodi adipisci, illum esse doloremque consectetur facere at ipsa fugiat sequi est voluptatibus labore culpa! Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis porro corporis vero nesciunt. Minus dolores consequatur repellendus! Quaerat enim illo aliquam nisi alias reprehenderit ullam similique explicabo pariatur? Deserunt, illum.</p>
                    </div>
                  </div>
                  <div class="first-section-product-cards">
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv1.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                          </div>
                        </div>
                      </a>
                    </span>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv2.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv3.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv4.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv5.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product1/lv-and-mv6.jpg" class="card-img-top resize__card1" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                ...
                <section class="first-section">
                  ...
                  <div class="first-section-product-cards">
                    <span class="">
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/contactor1.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/contactor2.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/contactor3.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/motor_starter1.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/motor_starter2.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/industrial_automation_products/motor_starter3.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                ...
                <section class="first-section">
                  ...
                  <div class="first-section-product-cards">
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/hybrid_inverter1.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/hybrid_inverter2.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/hybrid_inverter3.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/solar_charge_controller1.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/solar_charge_controller2.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
                    ...
                    <span>
                      <a href="product_menu_items.php" class="text-decoration-none text-dark">
                        <div class="card">
                          <img src="img/product3/solar_charge_controller3.jpg" class="card-img-top" alt="Product Image">
                          <div class="card-body">
                            <h5 class="card-title">Product title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn-link">View more <i class="fas fa-angle-right"></i></a>
...
<script>
  // -------multilevel-accordian-menu---------
    ...
    // ---------  FOR UNCHECK FUNCTION (RESET BUTTON) ---------
     // $(document).ready(function() {
    ...
    // ---------  FOR CHECK TO DISPLAY THE RESET BUTTON  ---------
    $(document).ready(function(){
      var $resetButon = $(".reset-btn").hide(),
          $checkBox = $('input[name="checkbox"]').click(function(){
            $resetButon.toggle($checkBox.is(":checked"));
          });
    });
