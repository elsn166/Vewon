...
$to="arunkumar15ece022@gmail.com";
...
$sql = "INSERT INTO vewon_contact_form (username, mobile, mail, message,address, company_name)
VALUES ('$Name', '$Mobile_no', '$Email_id', '$Message','$address', '$company_name' )";
...
<div class="detail">
<h1 style="font-size:16px; text-align:center; margin-top:30px; text-decoration:underline; color:#FF3333;"><strong>Course Enquiry Email</strong></h1>
  <table border="1" align="center" cellpadding="10" cellspacing="0" width="80%">
    ...
    <tr>
      <td  style="font-size:15px;width:50%;">Company :</td>
      <td >'.$company_name.'</td>
    </tr>
  </table><br>
</div>
