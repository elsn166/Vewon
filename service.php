...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Service | Vewon Group</title>
          ...
          <div class="site-header__middle">
            ...
            <ul class="nav__wrapper">
              ...
              <li class="nav__item text-capitalize dropdown">
                ...
                <ul class="dropdown-menu animate__animated animate__zoomIn" aria-labelledby="#dropdown">
                 <li><a class="dropdown-item" href="#s1">Installation & Testing and Commissioning</a></li>
                  <li><a class="dropdown-item" href="#s2">Operation & Maintenance Contract Services</a></li>
                  <li><a class="dropdown-item" href="#s3">Remote monitoring Web based portal Service</a></li>
                  <li><a class="dropdown-item" href="#s4">Spare Parts Supply</a></li>
                  <li><a class="dropdown-item" href="#s5">Electro  Mechanical Services</a></li>
                  <li><a class="dropdown-item" href="#s6">Human resource for Power related services</a></li>
                </ul> 
              </li>
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-touch="true" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src=https://images.squarespace-cdn.com/content/v1/5cadfb43e5f7d1662a8a4c82/1557512192795-SNE3ESS4SWRFP9MUS8ER/banner-electric.jpg?format=1500w" class="d-block w-100" alt="Image">
        <div class="caption">
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="image1.jpg" alt="Design Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    <div class="card-title">
                                        <h3 id="s1">Installation, Testing and Commissioning</h3>
                                    </div>

                                    <div class="card-textline-section">
                                        <p>Vewongroups make your installation process quick and cost-efficient. Our professionals provide excellent service in the process of installation.</p>
                                        <p>The infrastructure of a company is something which is heavily invested and insisted on. Lot of hard work and capital goes in. An electrical accident is totally undesirable.</p>
                  ...
                  <div class="card-body">
                      <ul class="d-flex">
                          <li class="row no-gutters">
                              <div class="col-md-6 image-card-section">
                                  <div class="card-image">
                                      <img src="image2.jpg" alt="Remote Monitoring Image">
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 card-text-section">
                                  <div class="card-title">
                                      <h3 id="s2">Operation & Maintenance Contract Services</h3>
                                  </div>

                                  <div class="card-textline-section">
                                      <p>Vewon is happy to provide our clients with superior maintenance service for the contract period. We provide operating and maintenance services for the project. </p>
                                      <p>Our professionals take care of your project and work with great passion towards its success. In the contract period, we took on all the responsibilities of the project. </p>
              ...
              <div class="card-body">
                  <ul class="d-flex">
                      <li class="row no-gutters list-row">
                          <div class="col-md-6 image-card-section">
                              <div class="card-image">
                                  <img src="image3.jpg" alt="Testing and Commission Image">
                              </div>
                          </div>
                          ...
                          <div class="col-md-6 card-text-section">
                              <div class="card-title">
                                  <h3 id="s3">Remote monitoring Web based portal Service</h3>
                              </div>

                              <div class="card-textline-section">
                                  <p>We provide you with a web-based portal service with a remote monitoring facility.</p>
                                  <p>Authority can remote admittance, monitor, and support the on-site equipment by the network and practicing a web browser externally the limit of domain and time.</p>
                                  <!--<p>The Vewon team will assess the electrical system of your property completely by deploying the latest tools. All the damages and potential damages including one to pests, rodents.</p>-->
                                  <!--<p>At Vewon we do the complete testing and commission. The reports are then documented for reference and knowledge purposes.</p>-->
                                </div>
                      ...
                      <div class="card-body">
                          <ul class="d-flex">
                              <li class="row no-gutters">
                                  <div class="col-md-6 image-card-section">
                                      <div class="card-image">
                                          <img src="https://media.istockphoto.com/photos/asian-female-warehouse-worker-in-safety-vest-and-helmet-working-with-picture-id1293066486?b=1&k=20&m=1293066486&s=170667a&w=0&h=dCwIJLuTWapPtl4sJyrtdP-ZPKvKv943B_Nzyp_3YaM=" alt="Remote Monitoring Image">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-md-6 card-text-section">
                                      <div class="card-title">
                                          <h3 id="s4">Spare Parts Supply</h3>
                                      </div>
    
                                      <div class="card-textline-section">
                                          <p>Vewongroups are pleased to provide quality spare parts at a low cost. We are the specialist in supplying vital, essential, and desirable spare parts. Our spare parts are pass out from many testings for long life.</p>
                                          <p>Clients are need not worry about their repair or the diminishing cost of the spare parts we provide, and our spare parts supply will bring you promising satisfaction on flexibility and long life. </p>
                                          <!--<p>Vewon offers remote monitoring infrastructure that guarantees that you keep in touch with what's progressing on without actually being there.</p>-->
                                          <!--<p>Appropriate responses, emails, and calls will be the trigger as proactive measures. Such an infrastructure guarantees the safety of your electrical distribution system.</p>-->
                                      </div>
              ...
              <div class="card-body">
                  <ul class="d-flex">
                      <li class="row no-gutters list-row">
                          <div class="col-md-6 image-card-section">
                              <div class="card-image">
                                  <img src="https://media.istockphoto.com/photos/harvester-engine-gear-chains-and-new-modern-mechanisms-picture-id1253091473?b=1&k=20&m=1253091473&s=170667a&w=0&h=wrLLS0umzlmcgRScWw1lENTzghRmF75v0L2Gjo_rbFM=" alt="Testing and Commission Image">
                              </div>
                          </div>
                          ...
                          <div class="col-md-6 card-text-section">
                              <div class="card-title">
                                  <h3 id="s5">Electro - Mechanical Services</h3>
                              </div>

                              <div class="card-textline-section">
                                  <p>Vewon focuses on providing service towards safeguarding your rotating electrical mechanisms through a distinct and wide range of repair, maintenances, and assistance solutions through on-site or workshop-based maintenance strategies.</p>
                                  <p>We proudly say that our expertise will timely identify and rectify the faults, are time-bound, and shared to facilitate quality analysis.</p>
                                  <!--<p>The Vewon team will assess the electrical system of your property completely by deploying the latest tools. All the damages and potential damages including one to pests, rodents.</p>-->
                                  <!--<p>At Vewon we do the complete testing and commission. The reports are then documented for reference and knowledge purposes.</p>-->
                                </div>
                      ...
                      <div class="card-body">
                          <ul class="d-flex">
                              <li class="row no-gutters">
                                  <div class="col-md-6 image-card-section">
                                      <div class="card-image">
                                          <img src="https://media.istockphoto.com/photos/woman-working-with-human-resources-software-on-computer-picture-id1306092452?b=1&k=20&m=1306092452&s=170667a&w=0&h=e1TYK-A23tmSB2FFHHB2UI6H5hUM-WJgmR3RXmZTn3Y=" alt="Remote Monitoring Image">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-md-6 card-text-section">
                                      <div class="card-title">
                                          <h3 id="s6">Human Resources for Power - related services</h3>
                                      </div>
    
                                      <div class="card-textline-section">
                                          <p>We are providing technical and non-technical labor force services in the area of constructing, general assembling, production constructing, operating and shut down preservation, human support services, and assist janitorial and widespread services.</p>
                                          <p>Hold your hand with our excellent powerful labor force.</p>
                                          <!--<p>Vewon offers remote monitoring infrastructure that guarantees that you keep in touch with what's progressing on without actually being there.</p>-->
                                          <!--<p>Appropriate responses, emails, and calls will be the trigger as proactive measures. Such an infrastructure guarantees the safety of your electrical distribution system.</p>-->
                                      </div>
