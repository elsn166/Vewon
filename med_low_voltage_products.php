...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Medium & Low Voltage Products | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/med_low_voltage_product_style.css" />
      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-touch="true" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=771&q=80" class="d-block w-100" alt="Image">
            <div class="banner-text">
              ...
              <a class="btn btn-info" role="button" href="product_menu.php">View Our Products</a> -->
            </div>
          </div>
...
<!--************* CAROUSEL SLIDER END *************-->
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://thumbs.dreamstime.com/b/worker-make-maintenance-electrical-equipment-st-petersburg-russia-october-engineer-services-testing-low-voltage-switchgear-84013709.jpg" alt="Design Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>Vewon Groups is one of the foremost solution providers in the power sector in India. </p>
                                        <p>We are engaged in designing types of equipment used in manufacturing industries. We provide MV and LV products with modern facilities. Our expertise having good experience and handled many sophisticated projects with great passion. </p>
                                        <p>We are good at manufacturing equipment with a classy look, modern facilities, low power consumption, working on low voltage. We are glad to say that we won our client's heart with our services. </p>
    ...
    <!-- CARD SECTION 1 ENDS -->
      ...
      <!-- CARD SECTION 2-->
        ...
        <!--    <h3>Discover Our Medium & Low Voltage Products</h3>-->
        <!--  </div>-->
        <!--</div>-->
        ...
        <!--          <div class="card shadow-sm resize__card mb-2">-->
        <!--            <img src="img/product1/lv-and-mv1.jpg" class="card-img-top" alt="LV and MV Product">-->
        <!--            <div class="card-body">-->
        <!--              <h5 class="card-title">LV and MV Product</h5>-->
                ...
                <!--<div class="col-md-3 col-lg-3">-->
                <!--  <div class="card shadow-sm resize__card mb-2">-->
                <!--    <img src="img/product1/lv-and-mv2.jpg" class="card-img-top" alt="LV and MV Product">-->
                <!--    <div class="card-body">-->
                <!--      <h5 class="card-title">LV and MV Product</h5>-->
                      <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a> -->
                ...
                <!--<div class="col-md-3 col-lg-3">-->
                <!--  <div class="card shadow-sm resize__card mb-2">-->
                <!--    <img src="img/product1/lv-and-mv3.jpg" class="card-img-top" alt="LV and MV Product">-->
                <!--    <div class="card-body">-->
                <!--      <h5 class="card-title">LV and MV Product</h5>-->
                      <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a> -->
                ...
                <!--<div class="col-md-3 col-lg-3">-->
                <!--  <div class="card shadow-sm resize__card mb-2">-->
                <!--    <img src="img/product1/lv-and-mv4.jpg" class="card-img-top" alt="LV and MV Product">-->
                <!--    <div class="card-body">-->
                <!--      <h5 class="card-title">LV and MV Product</h5>-->
                      <!-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a> -->
                ...
                <!-- <div class="col-md-3 col-lg-3">
                    <div class="card shadow-sm mb-2">
                      <img src="https://images.unsplash.com/photo-1448932223592-d1fc686e76ea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=749&q=80" class="card-img-top" alt="Card Image">
                      <div class="card-body">
                  ...
                  <div class="col-md-3 col-lg-3">
                    <div class="card shadow-sm mb-2">
                      <img src="https://images.unsplash.com/photo-1487611459768-bd414656ea10?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                  ...
                  <div class="col-md-3 col-lg-3">
                    <div class="card shadow-sm mb-2">
                      <img src="https://images.unsplash.com/photo-1522071901873-411886a10004?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                  ...
                  <div class="col-md-3 col-lg-3">
                    <div class="card shadow-sm mb-2">
                      <img src="https://images.unsplash.com/photo-1616587226960-4a03badbe8bf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1598350741860-3d0776f02ca3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
            ...
            <div class="col-md-6">
              <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1611365892117-00ac5ef43c90?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
