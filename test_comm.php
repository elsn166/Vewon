...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Testing and Commissioning | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/test_comm.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://www.assystem.com/wp-content/uploads/2018/11/Essais-mise-en-service.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Testing and Commissioning</h1>
            <!-- <div class="para">
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://media.istockphoto.com/photos/binders-are-waiting-to-be-processed-back-in-blur-picture-id533837953?b=1&k=20&m=533837953&s=170667a&w=0&h=VWSFTEPIOay1ewUJ3GtOV3BTpF4dP4wxByMzLb7ayPQ=" alt="Architect Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                      ...
                                      <p>Effective testing of or business properties at regular intervals is the key to stay away from imperils and also for ensuring maximum functionality.</p>
