...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Grid Automation | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/grid_automation.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://cdn.pixabay.com/photo/2017/03/05/00/34/panorama-2117310_960_720.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Grid Automation</h1>
            <!-- <div class="para">
        ...
        <!-- <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1558102746-4b0f0ac74e59?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=889&q=80" class="d-block w-100" alt="image">
          <div class="caption">
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://s7e3a.scene7.com/is/image/hitachiabbpowergrids/GRID%20INTEGRATION_Large-ABB_Brand_Campaign_for_Services_07?wid=480&hei=320&fmt=png-alpha&fit=crop%2C1" alt="Grid Automation Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>We are the specialists in providing grid automation products to bring you a more robust and efficient electrical power system.  </p>
                                        <p>Vewon groups integrating innovative instruments and technologies of generation, communication and administration to consumer devices and equipment.   </p>
                                        <p>Our grid automation products are utilizied by many energy services and their suppliers in applicability extending from power center integration to power plant dispatcing.  </p>
      ...
      <!-- CARD SECTION 2-->
        <!-- <div class="title-card-section2">
          <div class="title-section2">
            <h3>Discover our medium voltage distribution and grid automation offers</h3>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1444723121867-7a241cacace9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1559686043-aef1bbc98d19?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1599707254554-027aeb4deacd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=751&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                    ...
                    <div class="card-body">
                        <ul class="d-flex">
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://images.unsplash.com/photo-1596496638641-e240fd67b4c3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=755&q=80" alt="Card Image">
                                    </div>
                                </div>
