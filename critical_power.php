...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Critical Power | Vewon Group</title>
    ...
    <link rel="stylesheet" href="styles/critical_power.css" />
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade mb-3" data-bs-touch="true" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://hypertecdirect.com/wp-content/uploads/Storage-Banner.jpg" class="d-block w-100" alt="Image">
          <div class="caption">
            <h1 class="h1">Critical Power</h1>
            <!-- <div class="para">
            ...
            <a class="btn btn-primary learn-more-btn js-modal-btn" data-video-id="iYV4c-zwotU" role="button">Watch now</a> -->
          </div>
        </div>

       <!-- <div class="carousel-item">
          <img src="https://images.unsplash.com/photo-1519748174344-16e5d53bda7a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="d-block w-100" alt="image">
          <div class="caption">
            <h1 class="h1">Critical Power Business</h1>
            <div class="para">
              <p class="p">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt temporibus recusandae debitis voluptate labore aut. Praesentium et officiis reprehenderit ullam nihil, quisquam ipsum ducimus impedit, aliquam obcaecati suscipit asperiores animi?</p>
            </div>
            <a class="btn btn-primary learn-more-btn js-modal-btn" data-video-id="uIgO1bf1UMs" role="button">Watch now</a>
          </div>
        </div>
                            ...
                            <li class="row no-gutters list-row">
                                <div class="col-md-6 image-card-section">
                                    <div class="card-image">
                                        <img src="https://www.guideshome.co.uk/wp-content/uploads/2020/07/istockphoto-949711426-612x612-1.jpg" alt="Data Center Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 card-text-section">
                                    ...
                                    <div class="card-textline-section mt-5">
                                        <p>Vewon Groups pleased to provide a conditioned, reliable power to essential loads in industry and infrastructure spaces, comprising power for support like process equipment, buildings systems and crucial appliances.  </p>
                                        <p>We provide solutions take the form of UPS system that eradicate the influence of power presented incidents and disturbances. </p>
                                        <!-- <p>We provide resolutions for charging alternators, starters, batteries, batteries chargers, AC alternators, and control panels.  </p> -->
                            ...
                            <div class="card-body">
                                <ul class="d-flex">
                                    <li class="row no-gutters list-row">
                                        <div class="col-md-6 image-card-section">
                                            <div class="card-image">
                                                <img src="https://images.unsplash.com/photo-1598299803204-b73796f43289?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <ul class="d-flex">
                                    <li class="row no-gutters list-row">
                                        <div class="col-md-6 image-card-section">
                                            <div class="card-image">
                                                <img src="https://images.unsplash.com/photo-1593106410130-3f2fd4bfe436?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80" alt="Card Image">
                                            </div>
                                        </div>
      ...
      <!-- CARD SECTION 2-->
        <!-- <div class="title-card-section2">
          <div class="title-section2">
            <h3>Discover our Critical Power and Cooling Products</h3>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1590756254933-2873d72a83b6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1552853160-8ec65527b252?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://images.unsplash.com/photo-1622473541207-c59995fa6b4c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
                ...
                <div class="col-md-6 col-lg-3">
                  <div class="card shadow-sm mb-2">
                    <img src="https://media.wired.com/photos/5932dd98f682204f73697d86/master/pass/0621_AirConditioner.jpg" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="#" class="card-link">Go somewhere <span><i class="fas fa-angle-right"></i></span></a>
