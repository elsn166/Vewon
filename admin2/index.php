...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="active">
                <a class="nav-link" href="./index3.php" style="font-family: 'Poppins', sans-serif;">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle"  id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="img/user_profile.png" alt="User" style="margin-right: 25px;">
                            </a>
                        ...
                        <li class="nav-item" style="    padding: 24px 15px; opacity: 0;">
                          <a style="padding: 8px; backgroud-color: #f7f7f7; border-radius: 50%;" ><span class="material-icons-outlined" id="logout" onclick="logou()">logout</span></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="login-form/form.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="font-family: 'Poppins', sans-serif; font-weight: bold;"><i class="fas fa-scroll fa-sm text-white-50"></i>&nbsp; Register Asset</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Assets that are placed in Countries</h6>
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                <iframe title="" aria-label="Map" id="datawrapper-chart-Hf4Cf" src="https://datawrapper.dwcdn.net/Hf4Cf/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="394"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
                        ...
                        <div class="col-xl-5 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Assets Details</h6> <a href="md.php" > <button class="btn btn-secondary" type="button" data-dismiss="modal">More Details</button></a>
                                    <!-- <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Within 5 Years
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> Before 5 Years
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-danger"></i> Over 10 Years
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                No of Assets</div>
                                            <div class="h3 mb-0 font-weight-bold text-gray-800"><span class="count">
                                            <?php 
                                            ...
                                            //CODE FOR GETTING THE NUMBER OF ASSETS TO SHOWN IN ACTION CENTER CARDS
                                            $calcAsset = mysqli_query($conn, "SELECT COUNT(*) AS name_of_asset FROM register_asset");

                                            $calcresult = mysqli_fetch_array($calcAsset);
                                            echo $calcresult['name_of_asset']; ?> &nbsp;</span><span style="font-size: 0.8rem;">&nbsp; Assets</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Risk Free</div>
                                            <div class="h3 mb-0 font-weight-bold text-gray-800"><span class="count"><?php 
                                                //CODE FOR GETTING THE NUMBER OF ASSETS TO SHOWN IN ACTION CENTER CARDS
                                                $calcRiskFree = mysqli_query($conn, "SELECT diff_old FROM register_asset WHERE diff_old <= 5");

                                                $calcRiskFreeresult = mysqli_num_rows($calcRiskFree);
                                                echo $calcRiskFreeresult;
                                            ?> &nbsp;</span><span style="font-size: 0.8rem;">&nbsp; Assets</span></div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <div class="h3 mb-0 font-weight-bold text-gray-800"><span class="count"><?php 
                                                //CODE FOR GETTING THE NUMBER OF ASSETS TO SHOWN IN ACTION CENTER CARDS
                                                $calcRiskFree1 = mysqli_query($conn, "SELECT diff_old FROM register_asset WHERE diff_old BETWEEN 6 AND 10");

                                                $calcRiskFreeresult1 = mysqli_num_rows($calcRiskFree1);
                                                echo $calcRiskFreeresult1;
                                            ?> &nbsp;</span><span style="font-size: 0.8rem;">&nbsp; Assets</span></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card shadow h-100 py-2 mb-3">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Renewable Products</div>
                                            <div class="h3 mb-0 font-weight-bold text-gray-800 text-right count"><?php 
                                                //CODE FOR GETTING THE NUMBER OF ASSETS TO SHOWN IN ACTION CENTER CARDS
                                                $calcRiskFree2 = mysqli_query($conn, "SELECT diff_old FROM register_asset WHERE diff_old >= 10");

                                                $calcRiskFreeresult2 = mysqli_num_rows($calcRiskFree2);
                                                echo $calcRiskFreeresult2;
                                            ?></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        type: 'doughnut',
        data: {
            labels: ["before 5 Years", "After 5 Years", "Over 10 Years"],
            datasets: [{
            data: [<?php 
            //CODE FOR GETTING THE NUMBER OF ASSETS TO SHOWN IN ACTION CENTER CARDS
            $calcRiskFree = mysqli_query($conn, "SELECT diff_old FROM register_asset WHERE diff_old <= 5");
