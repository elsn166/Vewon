...
<head>
    ...
    <link rel="stylesheet" href="styles/building_automation_menu_style.css" />
        ...
        <div class="container-fluid wrapper">
          <!--********** NEW PAGE LINK STARTS***********-->
            <div class="pagelink-wrapper">
              <a href="building_automation.php">Building Automation &nbsp;<i class="fas fa-angle-right"></i></a>
            </div>
          <!--********** NEW PAGE LINK ENDS***********-->
            ...
            <!-- <div class="product-grid row">
              <div class="product-grid-mobile-column-1 col-12">
                <div class="product-category-column card" style="margin-top: 20px;">
                  <ul class="card-body">
                    <li><a href="product_menu_items.php"><span>Busway and Cable support</span><i class="fas fa-angle-right"></i></a></li>

                    <li><a href="product_menu_items.php"><span>Emergency Car Charging</span><i class="fas fa-angle-right"></i></a></li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            <div class="card-body">
                              <p class="card-text">Building Automation Product</p>
                              <!-- <p class="card-text"><small class="text-muted">Product Model Name</small></p> -->
                            </div>
                            <img src="img/product2/building_automation1.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation2.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation3.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation4.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                       <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation5.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>  
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation6.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation7.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation8.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                      ...
                      <li class="col-md-6 col-lg-4">
                        <a href="product_menu_items.php" class="text-decoration-none text-dark">
                          <div class="card text-center" style="margin-bottom: 20px;">
                            ...
                            <img src="img/product2/building_automation9.jpg" class="img-fluid rounded-start" class="card-img-bottom" alt="Building Automation Product" id="resize">
                          </div>
                        </a>
                      </li>
                    </ul>
