...
<head>
  ...
  <title>Register | Vewon Group</title>
        ...
        <div class="card bg-light mt-4">
            <article class="card-body mx-auto" style="min-width: 5rem;">
                ...
                <form action="change.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group input-group" id="mask">
                        <div class="input-group-prepend">
                            <!-- <span class="input-group-text"> <i class="fa fa-user"></i> </span> -->
                        </div>
                        <input name="fullname" id="fullname" class="form-control" placeholder="Full name" type="text" autofocus required>
                    </div>
                    <!-- form-group// -->
                    ...
                    <!-- Form group start -->
                    <div class="form-group input-group">
                        <select class="form-control" name="person-type" id="person-type" required>
                            <option selected="">Management</option>
                            <option value="customer" name="customers" id="customers">Customers</option>
                            <!--<option value="management" name="partners" id="partners">Management</option>-->
                            <option value="employee" name="employees" id="employees">Employees</option>
                        </select>
                    </div>
                    <!-- Form group end -->
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block" name="register-button"> Create Account  </button>
                    </div>
                     <!-- form-group// -->      
