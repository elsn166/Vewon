        ...
        <div class="wrapper site-header__wrapper" id="bottom_wrapper">
          ...
          <div class="site-header__middle">
            ...
            <div class="site-header--end">
              <a class="text-decoration-none text-capitalize mx-2" href="https://vewongroups.com/admin3" target="_blank" title="same account"> <i class="material-icons-outlined reg">Admin panel</i></a>
                            <a href="destroy.php" class="text-capitalize text-decoration-none" title="logout an account"> <i class="material-L-outlined login">log out</i></a>
